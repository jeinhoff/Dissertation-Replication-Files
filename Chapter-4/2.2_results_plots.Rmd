...
This R markdown file is used to create the cumulative risk and risk difference plots.
...
```{r}
plot_survival_r_h <- ggplot(survival_r_h, aes(x = age - 0.5, y = 1 - survival, group = group, fill = group)) +
  facet_grid(~country) +
  geom_stepribbon(aes(ymin = 1 - conf_low, ymax = 1 - conf_high), alpha = 0.25) +
  geom_step(aes(color = group), size = 0.8) +
  scale_x_continuous(NULL, limits = c(50, 66), breaks = seq(50, 65, 1)) +
  ...
  theme(legend.position=c(.0825,.91),
...
plot_survival_r_m_o <- ggplot(survival_r_m_o, aes(x = age - 0.5, y = 1 - survival, group = group, fill = group)) +
  facet_grid(~country) +
  geom_stepribbon(aes(ymin = 1 - conf_low, ymax = 1 - conf_high), alpha = 0.25) +
  geom_step(aes(color = group), size = 0.8) +
  scale_x_continuous(NULL, limits = c(50, 66), breaks = seq(50, 65, 1)) +
  ...
  theme_linedraw() +
  coord_cartesian(ylim = c(0,1), xlim = c(51, 65)) +
  theme(legend.position=c(.165,.91),
        text = element_text(colour = "black"),
        panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        panel.grid.minor.y = element_blank(),
...
plot_survival_rp_o <- ggplot(survival_rp_o, aes(x = age - 0.5, y = 1 - survival, group = group, fill = group)) +
  facet_grid(~country) +
  geom_stepribbon(aes(ymin = 1 - conf_low, ymax = 1 - conf_high), alpha = 0.25) +
  geom_step(aes(color = group), size = 0.8) +
  scale_x_continuous(NULL, limits = c(50, 66), breaks = seq(50, 65, 1)) +
...
plot_contrast_r_h <- ggplot(contrast_r_h, aes(x = age, y = (-1) * risk_diff, group = contrast, shape = contrast)) +
  facet_grid(~country) +
  geom_hline(yintercept = 0, size = 0.5, lty = 2, color = "red") +
  geom_line(color = "lightgrey", position = position_dodge(width = .5)) +
  geom_point(aes(color = sig), size = 2, position = position_dodge(width = .5)) +
  geom_errorbar(aes(ymin = (-1) * conf_low, ymax = (-1) * conf_high, color = sig), width = 0, position = position_dodge(width = .5)) +
  theme_classic() +
  coord_cartesian(xlim = c(51, 65), ylim = c(-0.11, 0.3)) +
...
plot_contrast_o_m <- ggplot(contrast_o_m, aes(x = age, y = risk_diff, group = contrast, shape = contrast)) +
  facet_grid(~country) +
  geom_hline(yintercept = 0, size = 0.5, lty = 2, color = "red") +
  geom_line(color = "lightgrey", position = position_dodge(width = .5)) +
  geom_point(aes(color = sig), size = 2, position = position_dodge(width = .5)) +
  geom_errorbar(aes(ymin = conf_low, ymax = conf_high, color = sig), width = 0, position = position_dodge(width = .5)) +
  theme_classic() +
  coord_cartesian(xlim = c(51, 65), ylim = c(-0.11, 0.3)) +
  scale_color_manual(values = c("lightgrey", "black")) +
  #scale_color_manual(values = c("black")) +
  guides(colour = "none") +
  theme_linedraw() +
  theme(legend.position = c(.175,.90),
        text = element_text(colour = "black"),
        panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        panel.grid.minor.y = element_blank(),
...
plot_contrast_r_m_o <- ggplot(contrast_r_m_o, aes(x = age, y = (-1) * risk_diff, group = contrast, shape = contrast)) +
  facet_grid(~country) +
  geom_hline(yintercept = 0, size = 0.5, lty = 2, color = "red") +
  geom_line(color = "lightgrey", position = position_dodge(width = .5)) +
  geom_point(aes(color = sig), size = 2, position = position_dodge(width = .5)) +
...
plot_contrast_rp_o <- ggplot(contrast_rp_o, aes(x = age, y = -risk_diff, group = contrast, shape = contrast)) +
  facet_grid(~country) +
  geom_hline(yintercept = 0, size = 0.5, lty = 2, color = "red") +
  geom_line(color = "lightgrey", position = position_dodge(width = .5)) +
  geom_point(aes(color = sig), size = 2, position = position_dodge(width = .5)) +
...
```{r}
plot_1 <- grid.arrange(plot_survival_r_h, plot_contrast_r_h, nrow = 2)
ggsave(".../plot_results_1_975.pdf", height = 10.5, width = 7.5, bg = "transparent", plot_1)

plot_2 <- grid.arrange(plot_survival_r_m_o, plot_contrast_r_m_o, nrow = 2)
ggsave(".../plot_results_2_975.pdf", height = 10.5, width = 7.5, bg = "transparent", plot_2)

plot_3 <- grid.arrange(plot_survival_r_m_o, plot_contrast_o_m, nrow = 2)
ggsave(".../plot_results_3_975.pdf", height = 10.5, width = 7.5, bg = "transparent", plot_3)

plot_4 <- grid.arrange(plot_survival_rp_o, plot_contrast_rp_o, nrow = 2)
ggsave(".../plot_results_4_975.pdf", height = 10.5, width = 7.5, bg = "transparent", plot_4)
