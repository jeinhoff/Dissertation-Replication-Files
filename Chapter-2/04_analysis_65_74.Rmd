...
ggplot(table_wle, aes(x = as.factor(cohort_two), y = WLE, group = country_code, country = country_code)) +
  ...
  geom_flag(data = table_wle %>% group_by(country_code, gender) %>% filter(cohort_two == min(cohort_two)) %>% slice(1), 
            aes(x = as.factor(cohort_two), y = WLE, group = country_code, country = country_code), 
            size = 3) +
  ...
  scale_y_continuous("WLE From Age 65 to 74 (in years)", breaks = seq(-10, 10, 1)) +
  scale_x_discrete("Birth Cohort", labels = c("'27/'28", "", "'31/'32", "", "'35/'36", "", "'39/'40", "", "'43/'44", "", "'47/'48", "", "'51/'52", "", "'55/'56")) +
  scale_alpha(range = c(0.01, 0.1))
ggsave("outputs/wle_unadjusted_65_74.pdf", width = 9, height = 6)
...
ggplot(table_wle, aes(x = as.factor(cohort_two), y = WLE, group = country_code, country = country_code)) +
  ...
  guides(x = "axis_minor", y = "axis_minor") +
  coord_cartesian(ylim = c(0, 8)) +
  scale_y_continuous("WLE From Age 65 to 74 (in FTE years)", breaks = seq(-10, 10, 1)) +
  scale_x_discrete("Birth Cohort", labels = c("'27/'28", "", "'31/'32", "", "'35/'36", "", "'39/'40", "", "'43/'44", "", "'47/'48", "", "'51/'52", "", "'55/'56")) +
  scale_alpha(range = c(0.01, 0.1))
ggsave("outputs/wle_adjusted_65_74.pdf", width = 9, height = 6)
...
ggplot(table_wle, aes(x = as.factor(cohort_two), y = WLE, group = country_code, country = country_code)) +
  ...
  scale_y_continuous("WYL From Age 65 to 74 (in years)", breaks = seq(-10, 10, 1)) +
  scale_x_discrete("Birth Cohort", labels = c("'27/'28", "", "'31/'32", "", "'35/'36", "", "'39/'40", "", "'43/'44", "", "'47/'48", "", "'51/'52", "", "'55/'56")) +
  scale_alpha(range = c(0.01, 0.1))
ggsave("outputs/wyl_retirement_65_74.pdf", width = 9, height = 6)
...
ggplot(table_wle, aes(x = as.factor(cohort_two), y = WLE, group = country_code, country = country_code)) +
  ...
  scale_x_discrete("Birth Cohort", labels = c("'27/'28", "", "'31/'32", "", "'35/'36", "", "'39/'40", "", "'43/'44", "", "'47/'48", "", "'51/'52", "", "'55/'56")) +
  scale_alpha(range = c(0.01, 0.1))
ggsave("outputs/wyl_unemployment_65_74.pdf", width = 9, height = 6)
...
ggplot(table_wle, aes(x = as.factor(cohort_two), y = WLE, group = country_code, country = country_code)) +
  ...
  scale_x_discrete("Birth Cohort", labels = c("'27/'28", "", "'31/'32", "", "'35/'36", "", "'39/'40", "", "'43/'44", "", "'47/'48", "", "'51/'52", "", "'55/'56")) +
  scale_alpha(range = c(0.01, 0.1))
 ggsave("outputs/wyl_inactivity_65_74.pdf", width = 9, height = 6)
